...
(async () => {
    try{
        ...
        await bridgeNodeContractHttp.methods.registerBridgeNode("Hospital-BridgeNode-One", "127.0.0.1", "3009", "0x95c0abb132fef71d6351cfde3daecc06b5f14d08", "9545").send({from: myAccountAddress});
        await bridgeNodeContractHttp.methods.registerBridgeNode("Hospital-BridgeNode-Two", "127.0.0.1", "3010", "0xfe98d6e761e11e9752b08c655910256899bf366a", "9545").send({from: myAccountAddress});
        await bridgeNodeContractHttp.methods.registerBridgeNode("Hospital-BridgeNode-Three", "127.0.0.1", "3011", "0x21d4935c9bc94b4cf5b87555e0eaf767c66f77fd", "9545").send({from: myAccountAddress});
