...
(async () => {
    try{
        await bridgeNodeContractHttp.methods.registerBridgeNode("CareCenter-BridgeNode-One", "http://localhost:3002", "0xa93278ed1977727474ccd5b0d4ac313037d7f8a6", "7545").send({from: myAccountAddress});
        await bridgeNodeContractHttp.methods.registerBridgeNode("CareCenter-BridgeNode-Two", "http://localhost:3003", "0x281c5cb496a751305b0dd7907320ee55836095c6", "7545").send({from: myAccountAddress});
        await bridgeNodeContractHttp.methods.registerBridgeNode("CareCenter-BridgeNode-Three", "http://localhost:3004", "0x406986b7f121e58453cff9950a27e75ba9d8ea82", "7545").send({from: myAccountAddress});
